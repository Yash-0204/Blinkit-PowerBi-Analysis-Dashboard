...
Custom theme — "Blinkit Dark Mode Pro" (yellow 
#F8CD51 on near-black 
#161616), built from scratch to match brand identity
📊 Screenshots
...
🚀 How to Use
Download Blinkit_Sales_Dashboard.pbix from this repo
Open in Power BI Desktop (free download from Microsoft)
Use the Year, Zone, and Category slicers to explore the data interactively
